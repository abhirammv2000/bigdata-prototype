...
> ⚠️ **LEGACY / HISTORICAL DOCUMENT — not the current deployment.**
> This describes the original **Cloud Run + Cloud Composer + Cloud Logging**
> deployment. The project is now deployed on **GKE** — see the root
> [`README.md`](../../README.md). The Live URLs below are no longer active.
